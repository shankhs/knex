...
function Runner_Mongo() {
  this.client = client;
  Runner.apply(this, arguments);
}
inherits(Runner_Mongo, Runner);

// Grab a connection, run the query via the Mongo streaming interface,
// and pass that through to the stream we've sent back to the client.
Runner_Mongo.prototype._stream = Promise.method(function(sql, stream, options) {
  var runner = this;
...
Runner_Mongo.prototype._query = Promise.method(function(obj) {
  var sql = obj.sql;
...
Runner_Mongo.prototype.processResponse = function(obj) {
